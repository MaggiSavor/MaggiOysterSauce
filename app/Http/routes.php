...
Route::group(['middleware' => ['auth']], function(){
	Route::group(array('prefix' => 'standard/'), function(){
		...
		Route::get('/resident_list', array('uses' => 'StandardUserController@residentList', 'as' => 'residentList1'));
		Route::get('/household_list', array('uses' => 'StandardUserController@householdList', 'as' => 'householdList1'));
		Route::get('/family_list', array('uses' => 'StandardUserController@familyList', 'as' => 'familyList1'));
		Route::get('/female_list', array('uses' => 'StandardUserController@femaleList', 'as' => 'femaleList1'));
		Route::get('/male_list', array('uses' => 'StandardUserController@maleList', 'as' => 'maleList1'));
		Route::get('/voter_list', array('uses' => 'StandardUserController@voterList', 'as' => 'voterList1'));
		Route::get('/senior_list', array('uses' => 'StandardUserController@seniorList', 'as' => 'seniorList1'));
		Route::get('/transferred_list', array('uses' => 'StandardUserController@transferredList', 'as' => 'transferredList1'));
		Route::get('/documents_list', array('uses' => 'StandardUserController@documentsList', 'as' => 'documentsList1'));
		Route::get('/certificate_list', array('uses' => 'StandardUserController@certificateList', 'as' => 'certificateList1'));
		Route::get('/good_moral_list', array('uses' => 'StandardUserController@goodMoralList', 'as' => 'goodMoralList1'));
