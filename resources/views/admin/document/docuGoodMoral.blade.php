                            ...
                            <table width="100%" class="table table-hover mails m-0 table table-actions-bar" id="residentsTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><a href="{{URL::Route('goodMoralPrint', $residentList['id'])}}"><button type="button" class="btn btn-success" name="issue" id="issue"> <span class="glyphicon glyphicon-file"></span> Issue Certificate</button></a></td>
                                    </tr>
                                    @endforeach
