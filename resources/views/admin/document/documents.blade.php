            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="panel panel-default">
                        ...
                        <!-- <div style=" width: 240px;" class="col-xs-6 col-md-3">
                        <div style=" width: 192px; height: 240px;"  class="ih-item square effect13 left_to_right">
                        <a href="DocuMoral.php" class="thumbnail">
                        <div class="img"><img src="../assets/images/gmlogo.jpg" alt="6"></div>
                                <div class="info">
                                    <img src="../assets/images/goodmoral.jpg" alt="6">
                                </div>
                            </a>
                        </div>
                        </div>
                        ...
                        <div style=" width: 240px;" class="col-xs-6 col-md-3">
                        <div style=" width: 192px; height: 240px;"  class="ih-item square effect13 left_to_right">
                        <a href="DocuCert.php" class="thumbnail">
                        <div class="img"><img src="../assets/images/coilogo.jpg" alt="6"></div>
                                <div class="info">
                                    <img src="../assets/images/indigency.jpg" alt="6">
                                </div>
                            </a>
                        </div>
                        </div>
                        ...
                        <div style=" width: 240px;" class="col-xs-6 col-md-3">
                        <div style=" width: 192px; height: 240px;"  class="ih-item square effect13 left_to_right">
                        <a href="DocuBID.php" class="thumbnail">
                        <div class="img"><img src="../assets/images/bidlogo.jpg" alt="6"></div>
                                <div class="info">
                                    <img src="../assets/images/id1.jpg" alt="6">
                                </div>
                            </a>
                        </div>
                        </div>
                        ...
                        <div style=" width: 240px;" class="col-xs-6 col-md-3">
                            <div style=" width: 192px; height: 240px;"  class="ih-item square effect13 left_to_right">
                            <a href="DocuPermit.php" class="thumbnail">
                                <div class="img"><img src="../assets/images/bpermitlogo.jpg" alt="6"></div>
                                <div class="info"><img src="../assets/images/permit3.jpg" alt="6"></div>
                                </a>
                            </div>
