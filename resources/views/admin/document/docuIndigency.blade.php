...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="padding-top: 0%;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Certificate of Indigency</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
           <!-- /.row -->
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div id="printableArea{{$res['id']}}" hidden style="position: absolute;">
                    <img src="../assets/images/indigency.jpg" style="height: 11in; width: 8.5in;">
                    <p style="position:absolute; left:32%; top:29.7%;">{{$res['fullname']}}</p>
                    <p style="position:absolute; left:80%; top:29.7%;" class="age"></p>
                    <p style="position:absolute; left:14%; top:31.7%;">{{$res['status']}}</p>
                    <p style="position:absolute; left:62%; top:72.8%;">{{$chairman['fullname']}}</p>
                    <?php
                    $date1 = date("d");
                    $date2 = date("F");
                    $date3 = date("Y") - 2000;
                    echo '<p style="position:absolute; left:80%; top:54%;">'.$date1.'</p>
                        <p style="position:absolute; left:10%; top:55.7%;">'.$date2.'</p>
                        <p style="position:absolute; left:32.8%; top:55.7%;">'.$date3.'</p>';
                    ?>
                </div>
