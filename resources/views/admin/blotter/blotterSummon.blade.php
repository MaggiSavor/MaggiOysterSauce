                            ...
                            <table width="100%" class="table table-hover mails m-0 table table-actions-bar" id="summon">
                                ...
                                @foreach($summon as $summons)
                                    <tr>
                                       ...
                                       <td><button type="button" class="btn btn-success cj" name="issue" id="issue" data-toggle="modal" data-target="#myModal{{$summons['id']}}" value="{{$summons['id']}}"> <span class="glyphicon glyphicon-file"></span> Reprint Summon Letter</button></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div id="printableArea{{$summons['id']}}" hidden style="position: absolute;">
                      ...
                      <p style="position:absolute; left:75.4%; top:16.9%;">{{$summons['id']}}</p>
